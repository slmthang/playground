...
let myArray1 = buildArray([43, 45, 11, 43, 23], 'ascending');
let myArray2 = buildArray([43, 45, 11, 43, 23], 'descending');

/*  EXERCISE 2
    TODO: Update the LoanCalculator function. */

function loanCalculator (principle: number, interestRate: number, months: number) : number {
